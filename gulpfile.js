...
elixir(function(mix) {
    ...
    mix.styles(['slicklab/slidebars.css', 'slicklab/bootstrap.min.css',
        ...
        'slicklab/style.css', 'slicklab/style-responsive.css'],
        'public/css/admin/vendor.css');
    mix.scripts(['slicklab/jquery-1.10.2.min.js', 'slicklab/bootstrap.js',
        'slicklab/vue.min.js', 'slicklab/jquery.nicescroll.js',
        'slicklab/slidebars.min.js', 'slicklab/scripts.js'],
